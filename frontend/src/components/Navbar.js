...
export default function Navbar() {
  ...
  // const [showForecastingScenario, setShowForecastingScenario] = useState(false);
  ...
  useEffect(() => {
    setShowSaveClose(location.pathname === '/forecasting-forcasting-scenario' || location.pathname === '/forecasting-forcasting-scenario/Fiscal_Volumes'); // or your exact route
  }, [location.pathname]);
